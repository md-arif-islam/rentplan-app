                ...
                <div className=" md:flex md:space-x-3 lg:space-x-5 space-y-3">
                    <div className="flex-1">
                        <div className="flex space-x-2 lg:space-x-12 rtl:space-x-reverse">
                            <div className=" font-medium  min-w-[110px] md:text-sm text-sm text-slate-900 dark:text-slate-300  space-y-3 ">
                                <p>Order Date:</p>
                                <p>Name:</p>
                                <p>Email:</p>
                                <p>Shipping address:</p>
                            </div>
                            <div className="font-normal md:text-sm text-sm text-slate-900 dark:text-slate-300  space-y-3 min-w-[110px] ">
                                    ...
                                    <div className="flex-none min-w-[270px] space-y-3">
                                        <div className="space-y-3">
                                            <div className="flex justify-between">
                                                <span className="font-medium text-slate-900 text-sm lg:text-sm dark:text-slate-300">
                                                    Subtotal:
                                                </span>
                                                <span className="text-slate-900 dark:text-slate-300 font-medium text-sm lg:text-sm">
                                                    ${totalPrice}
                                                </span>
                                            </div>
                                            <div className="flex justify-between">
                                                ...
                                                <span className="text-slate-700 dark:text-slate-300 text-sm lg:text-sm font-normal">
                                                    $00.00
                                                </span>
                                            </div>
                                            <div className="flex justify-between">
                                        ...
                                        <div className="border-t dark:border-slate-700 ">
                                            <div className="flex justify-between pt-3">
                                                ...
                                                <span className="text-slate-900 dark:text-slate-300 text-sm lg:text-sm">
                                                    ${totalPrice}
                                                </span>
                                            </div>
                                        </div>
