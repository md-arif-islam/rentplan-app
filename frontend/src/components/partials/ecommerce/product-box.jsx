        ...
        <Card bodyClass="p-4 rounded-md" className="group ">
            ...
            <div>
                <div className="flex justify-between items-center ">
                    <p className="text-sm	text-slate-900 dark:text-slate-300 uppercase font-normal">
                        {category}
                    </p>
                    {rating && (
                        <span className="flex items-center text-slate-900 dark:text-slate-300  font-normal text-sm space-x-1  rtl:space-x-reverse ">
                            <Icon
                                icon="ph:star-fill"
