        ...
        <div className="grid xl:grid-cols-2 grid-cols-1 gap-5">
            ...
            <Card title="Raised">
                <div className="space-xy-5">
                    ...
                    <Button
                        text="secondary"
                        className=" btn-secondary shadow-base2"
                    />
                    <Button
                        text="success"
                        className=" btn-success shadow-base2"
                    />
            ...
            <Card title="Rounded">
                <div className="space-xy-5">
                    ...
                    <Button
                        text="secondary"
                        className=" btn-secondary rounded-[999px]"
                    />
                    <Button
                        text="success"
                        className=" btn-success rounded-[999px]"
                    />
                    <Button text="info" className=" btn-info rounded-[999px]" />
                    <Button
                        text="warning"
                        className=" btn-warning rounded-[999px]"
                    />
                    <Button
                        text="danger"
                        className=" btn-danger rounded-[999px]"
                    />
                    <Button text="Dark" className=" btn-dark rounded-[999px]" />
                    <Button
                        text="Light"
                        className=" btn-light rounded-[999px]"
                    />
                    <Button
                        text="White"
            ...
            <Card title="Rounded Outline">
                <div className="space-xy-5">
                    ...
                    <Button
                        text="info"
                        className="btn-outline-info rounded-[999px]"
                    />
                    <Button
                        text="warning"
                    ...
                    <Button
                        text="dark"
                        className="btn-outline-dark rounded-[999px]"
                    />
                    <Button
                        text="light"
                        className="btn-outline-light rounded-[999px]"
                    />
                </div>
            </Card>
            <Card title="Icon">
