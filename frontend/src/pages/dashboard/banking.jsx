                     ...
                     ${
                      ...
                      `}
                            ...
                            <div className="bg-slate-100 dark:bg-slate-900 rounded-md p-4">
                                <span
                                    className="text-sm text-slate-500 dark:text-slate-400 block mb-1 cursor-pointer font-normal"
                                    htmlFor="cdp"
                                >
                                    Amount
                                </span>
                            ...
                            <div className="bg-slate-100 dark:bg-slate-900 rounded-md p-4">
                                <label
                                    className="text-sm text-slate-500 dark:text-slate-400 block cursor-pointer mb-1"
                                    htmlFor="cd"
                                >
