                        ...
                        <Card>
                            ...
                            <div className="card-text dark:text-slate-300 mt-4 space-y-4 leading-5 text-slate-600 text-sm border-b border-slate-100 dark:border-slate-700 pb-6">
                                <p>
                                    ...
                                    aliquip.Lorem ipsum dolor sit amet,
                                ...
                                <p>
                                    ...
                                    Ut enim ad minim veniam, quis nostrud
                                    exercitation ulla mco laboris nisi ut
                                    aliquip ex ea commodo consequat. Duis aute
                                    irure dolor in reprehende rit in voluptate
                                ...
                                <ul className="lg:flex items-center lg:space-x-3 lg:rtl:space-x-reverse mt-4 border-b border-slate-100 dark:border-slate-700 pb-6">
                                    ...
                                    {tags.map((item, i) => (
                                        <li key={i}>
                                            <Link
                                                to="#"
                                                className="text-sm font-normal text-slate-600 dark:text-slate-300 bg-slate-100 dark:bg-slate-600 py-1 px-3 rounded-full hover:bg-slate-900 hover:text-white transition duration-150"
                                            >
                                        ...
                                        <div className="flex">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-sm text-slate-500 dark:text-slate-400">
                                                    ...
                                                    incididun ut lab ore et
                                                    dolore magna aliqua.
                                                </p>
                                                <div className="mt-2">
                                                    <Link
                                                        to="#"
                                                        className="flex space-x-2 items-center dark:text-slate-500 text-sm font-medium rtl:space-x-reverse"
                                                    >
                                                        <span>Reply</span>
                                                        <Icon
