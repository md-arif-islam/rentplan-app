        ...
        <div className="space-y-5 divide-y divide-slate-100 dark:divide-slate-700 -mx-6">
                ...
                <ul className="flex flex-wrap">
                    {tags.map((item, i) => (
                        <li key={i} className="mr-2 mb-2">
                            <Link
                                to={item.link}
                                className="text-sm font-normal text-slate-600 bg-slate-100 dark:bg-slate-600 dark:text-slate-300 py-1 px-3 rounded-full hover:bg-slate-900 hover:text-white transition duration-150"
                            >
            ...
            <div className="mx-6 bg-slate-900 dark:bg-slate-900 text-white rounded-xl p-6 space-y-4">
                ...
                <form action="#" className="space-y-4">
                    ...
                    <button
                        type="button"
                        className="btn btn-light btn-sm w-full"
                    >
                        Subscribe
                    </button>
                </form>
