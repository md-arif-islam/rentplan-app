            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-5">
                <Card title="HTML headings Default">
                    <div className="text-sm text-slate-600 dark:text-slate-300">
                        All HTML headings, are available. .h1 through .h7
                        classes are also available, for when you want to match
                        the font styling of a heading.
                    </div>
                    <div className="bg-slate-100 dark:bg-slate-700 text-sm text-slate-600 dark:text-slate-300 flex justify-between py-3 px-6 items-center -mx-6 mt-6 mb-6 font-semibold">
                        <span>PREVIEW</span>
                        <span>FONT SIZE</span>
                    </div>
                ...
                <Card title="Light / Bold Headings">
                    <div className="text-sm text-slate-600 dark:text-slate-300">
                        ...
                        font-weight. Use .font-weight-normal for light heading
                        and .
                    </div>
                    <div className="bg-slate-100 dark:bg-slate-700 text-sm text-slate-600 dark:text-slate-300 flex justify-between py-3 px-6 items-center -mx-6 mt-6 mb-6 font-semibold">
                    ...
                    <Card title="Texts">
                        <div className="-mx-6">
                            <table className="w-full border-collapse border-none text-left">
                                <thead>
                                    <tr>
                                        <th className="text-sm font-semibold bg-slate-100 dark:bg-slate-700">
                ...
                <Card title="Display Headings">
                    <div className="text-sm text-slate-600 dark:text-slate-300 mb-6">
                        ...
                        heading to stand out, consider using a display heading—a
                    ...
                    <Card title="Text Color">
                        <div className="space-y-4">
                            ...
                            <p className="text-sm font-light text-warning-500">
                                This is warning-500 text You can archive this
                                adding .text-warning-500 class
                            </p>
                            <p className="text-sm font-light text-danger-500">
                                This is danger-500 text You can archive this
                                adding .text-danger-500 class
                            </p>
                        </div>
                    </Card>
                </div>
                    ...
                    <Card title="Blockquotes">
                        <div className="space-y-5">
                            <blockquote className="text-slate-900 dark:text-slate-300">
                                ...
                                adipisicing elit. Accusamus laudantium omnis
                                fugit ducimus nulla libero temporibus corrupti
                                non voluptatem harum?
