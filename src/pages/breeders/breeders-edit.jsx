...
const BreedersEdit = () => {
    ...
    // Fetch breeder data from API
    const { data, isLoading, error } = useGetBreederEditDataQuery(id);

    useEffect(() => {
        if (!isLoading && data) {
            dispatch(setBreeder(data));
            setShowAgentFields(data.breeder?.agent || false);
        }
    }, [data, isLoading, dispatch]);

    const breeder = useSelector((state) => state.breeders.breeder) || {};

    const [updateBreeder, { isLoading: isUpdating }] =
        useUpdateBreederMutation();
    ...
    const handleSubmit = async (e) => {
        ...
        console.log("Breeder data to be updated:", breeder.breeder);

        try {
            await updateBreeder(breeder.breeder).unwrap();
            toast.success("Breeder updated successfully");
            navigate("/admin/breeders");
        } catch (error) {
            console.error("Error updating breeder:", error);
            toast.error(error?.data?.message || "Failed to update breeder");
        }
    };
                ...
                <Card title="Company Information">
                    <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5">
                        <Textinput
                            ...
                            defaultValue={breeder.breeder.company_name}
                            onChange={(e) =>
                                dispatch(
                                    setBreeder({
                                        ...breeder,
                        ...
                        <Textinput
                            ...
                            defaultValue={breeder.breeder.representive}
                            onChange={(e) =>
                                dispatch(
                                    setBreeder({
                                        ...breeder,
                        ...
                        <Select
                            ...
                            value={breeder.breeder.currency || ""}
                            onChange={(e) =>
                                dispatch(
                                    setBreeder({
                                        ...breeder,
                        ...
                        <Select
                            ...
                            value={breeder.breeder.language || ""}
                            onChange={(e) =>
                                dispatch(
                                    setBreeder({
                                        ...breeder,
                ...
                <Card title="Contact Information" className="mt-5">
                    <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5">
                        <Textinput
                            ...
                            defaultValue={breeder.breeder.phone}
                        ...
                        <Textinput
                            ...
                            defaultValue={breeder.breeder.email}
                ...
                <Card title="Address" className="mt-5">
                    <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5">
                        <Textinput
                            ...
                            defaultValue={breeder.breeder.address}
                            onChange={(e) =>
                                dispatch(
                                    setBreeder({
                                        ...breeder,
                        ...
                        <Textinput
                            ...
                            defaultValue={breeder.breeder.city}
                            onChange={(e) =>
                                dispatch(
                                    setBreeder({
                                        ...breeder,
                        ...
                        <Textinput
                            ...
                            defaultValue={breeder.breeder.post_code}
                            onChange={(e) =>
                                dispatch(
                                    setBreeder({
                                        ...breeder,
