                ...
                {customers.map((item, i) => (
                    ...
                    >
                        ...
                        >
                            ...
                            />
                            <span className="h-[27px] w-[27px] absolute right-0 bottom-0 rounded-full bg-[#FFC155] border border-white flex flex-col items-center justify-center text-white text-sm font-medium">
                                {item.number}
                            </span>
                        </div>
                        ...
                        <div className="inline-block bg-slate-900 text-white px-[10px] py-[6px] text-sm font-medium rounded-full min-w-[60px]">
                            {item.value}
                        </div>
                        <div>
            ...
            <div className="grid grid-cols-1 gap-5 mt-5">
                {customers2.map((item, i) => (
                    ...
                    >
                        ...
                        <div className="inline-block text-center bg-slate-900 text-white px-[10px] py-[6px] text-sm font-medium rounded-full min-w-[60px]">
                            {item.value}
                        </div>
