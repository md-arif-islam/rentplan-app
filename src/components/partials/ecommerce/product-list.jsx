...
const ProductList = ({ item }) => {
    ...
    return (
        ...
        >
            ...
            <div>
                <p className="text-sm	text-slate-900 dark:text-slate-300 font-normal uppercase pb-2">
                    {category}
                </p>
                ...
                {rating && (
                    <span className="flex items-center text-slate-900 dark:text-slate-300  font-normal text-sm space-x-[4px] rtl:space-x-reverse pb-3">
